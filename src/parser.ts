...
export default class OASParser {

    static async flattenReferences(specificationSource: string, specificationDestination?: string): Promise<void | $RefParser.JSONSchema> {
